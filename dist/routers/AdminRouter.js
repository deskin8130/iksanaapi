...
class AdminRouter {
    ...
    patchRoutes() {
        this.router.patch('/update', GlobalMiddleWare_1.GlobalMiddleWare.adminAuthenticate, GlobalMiddleWare_1.GlobalMiddleWare.checkError, AdminController_1.AdminController.update);
    }
    deleteRoutes() {
    }
}
