...
const BlogCategoryRouter_1 = require("./routers/BlogCategoryRouter");
...
class Server {
    ...
    setRoutes() {
        ...
        this.app.use('/api/blog_category', BlogCategoryRouter_1.default);
        this.app.use('/api/blog', BlogRouter_1.default);
